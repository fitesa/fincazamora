...
lyr_FincaVecino_1.set('fieldAliases', {'TIPO': 'TIPO', 'SUPERFICIE': 'SUPERFICIE', });
lyr_FincaZamora_2.set('fieldAliases', {'TIPO': 'TIPO', 'SUPERFICIE': 'SUPERFICIE', 'IMAGEN': 'IMAGEN', });
lyr_FincaVecino_1.set('fieldImages', {'TIPO': 'TextEdit', 'SUPERFICIE': 'TextEdit', });
lyr_FincaZamora_2.set('fieldImages', {'TIPO': 'TextEdit', 'SUPERFICIE': 'TextEdit', 'IMAGEN': 'TextEdit', });
lyr_FincaVecino_1.set('fieldLabels', {'TIPO': 'header label', 'SUPERFICIE': 'inline label', });
lyr_FincaZamora_2.set('fieldLabels', {'TIPO': 'header label', 'SUPERFICIE': 'inline label', 'IMAGEN': 'no label', });
